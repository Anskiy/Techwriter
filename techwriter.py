...
"descpointer": [0x2B,0x3B], "mp_cost": 2, "targeting": [7,0]}
...
"descpointer": [0x39,0x3B], "mp_cost": 4, "targeting": [7,0]}
...
life = {"attack_byte": 0, "effect": 0, "tech_id": 6, "efpointer": [1,0xCA,0x80,0,0,0,0,0xA0,0,0,0,0], 	
...
"descpointer": [0x64,0x3B], "mp_cost": 12, "targeting": [7,0]}
...
aura = {"attack_byte": 0x00, "effect": 0, "tech_id": 9, "efpointer": [0,5,0x80,0,0,0,0,0,0,0,0,0],
...
"descpointer": [0xB2,0x3B], "mp_cost": 2, "targeting": [7,0]}
cure = {"attack_byte": 0x00, "effect": 0, "tech_id": 0xC, "efpointer": [00,0x0E,0x80,00,00,00,00,00,00,00,00,00],
"anim": [0x0B,0xE1,2,0x1E,0x0B,0x0B,0xFF], "text": [0x2F,0xA2,0xCE,0xCB,0xBE,0xEF,0xEF,0xEF,0xEF,0xEF,0xEF],
"descpointer": [0xC3,0x3B], "mp_cost": 2, "targeting": [0x80,0]}
...
ice2 = {"attack_byte": 0x22, "effect": 7, "tech_id": 0xE, "efpointer": [3,00,00,00,00,3,0x3C,0x70,00,0xE,00,00],
...
cure2 = {"attack_byte": 0x00, "effect": 0, "tech_id": 0xF, "efpointer": [0,0x18,0x80,00,00,00,00,00,00,00,00,00],
"anim": [0x0E,0xE1,2,0x1F,0x0B,0x0E,0xFF], "text": [0x2F,0xA2,0xCE,0xCB,0xBE,0xFF,0xD6,0xEF,0xEF,0xEF,0xEF],
"descpointer": [0xFE,0x3B], "mp_cost": 5, "targeting": [0x80,0]}
...
"descpointer": [0x31,0x3C], "mp_cost": 1, "targeting": [8,0]}
...
"descpointer": [0x41,0x3C], "mp_cost": 2, "targeting": [7,0]}
napalm = {"attack_byte": 0x12, "effect": 7, "tech_id": 0x14, "efpointer": [3,0,0,0x3A,0x3B,3,0x3C,0x50,0,0xD,0,0x80],
"anim": [0x14,0xF1,0,0x0A,0x14,0x14,0x49], "text": [0xAD,0xBA,0xC9,0xBA,0xC5,0xC6,0xEF,0xEF,0xEF,0xEF,0xEF],
"descpointer": [0x55,0x3C], "mp_cost": 3, "targeting": [0x12,3]}
...
fire2 = {"attack_byte": 0x12, "effect": 7, "tech_id": 0x16, "efpointer": [3,0,0,0,0,3,0x3C,0x70,0,0xE,0,0],
...
curebeam = {"attack_byte": 0, "effect": 0, "tech_id": 0x1A, "efpointer": [0,0xE,0x80,0,0,0,0,0,0,0,0,0],
"anim": [0x1A,0xE1,2,0x1E,0xB,0xB,0x5A], "text": [0xA2,0xCE,0xCB,0xBE,0xFF,0xA1,0xBE,0xBA,0xC6,0xEF,0xEF],
"descpointer": [0xC9,0x3C], "mp_cost": 2, "targeting": [0x80,0]}
...
"descpointer": [0xDA,0x3C], "mp_cost": 3, "targeting": [8,0]}
robotackle = {"attack_byte": 4, "effect": 0, "tech_id": 0x1C, "efpointer": [3,0,0,0x3A,0x3B,5,0x3E,0x80,0x80,0x15,4,0x80],
"anim": [0x1B,0x61,0xE0,0x26,0x1B,0x1B,9], "text": [0xB1,0xC8,0xBB,0xC8,0xFF,0xB3,0xBA,0xBC,0xC4,0xC5,0xBE],
"descpointer": [0xEC,0x3C], "mp_cost": 4, "targeting": [7,0]}
healbeam = {"attack_byte": 0, "effect": 0, "tech_id": 0x1D, "efpointer": [0,0xA,0x80,0,0,0,0,0,0,0,0,0],
"anim": [0x1D,0xE1,2,0x13,0xB,0xB,0x59], "text": [0xA7,0xBE,0xBA,0xC5,0xFF,0xA1,0xBE,0xBA,0xC6,0xEF,0xEF],
"descpointer": [0xF7,0x3C], "mp_cost": 3, "targeting": [0x81,0]}
...
"descpointer": [0xB,0x3D], "mp_cost": 12, "targeting": [7,0]}
...
slurp = {"attack_byte": 0, "effect": 0, "tech_id": 0x21, "efpointer": [0,5,0x80,0,0,0,0,0,0,0,0,0],
...
"descpointer": [0x73,0x3D], "mp_cost": 2, "targeting": [7,0]}
...
"descpointer": [0x86,0x3D], "mp_cost": 2, "targeting": [0x81,0]}
...
water2 = {"attack_byte": 0x22, "effect": 7, "tech_id": 0x26, "efpointer": [3,0,0,0,0,3,0x3C,0x70,0,0xE,0,0],
...
cure2_2 = {"attack_byte": 0, "effect": 0, "tech_id": 0x27, "efpointer": [0,0x18,0x80,0,0,0,0,0,0,0,0,0],
"anim": [0x27,0xE1,2,0x1F,0xB,0xE,0xFF], "text": [0x2F,0xA2,0xCE,0xCB,0xBE,0xFF,0xD6,0xEF,0xEF,0xEF,0xEF],
"descpointer": [0xBF,0x3D], "mp_cost": 5, "targeting": [0x80,0]}
...
kiss = {"attack_byte": 0, "effect": 0, "tech_id": 0x29, "efpointer": [1,0x4E,0x80,0,0,0,0,0xA0,0,0,0,0],
"anim": [0x29,0xE1,5,0x1D,9,9,0xFF], "text": [0xAA,0xC2,0xCC,0xCC,0xEF,0xEF,0xEF,0xEF,0xEF,0xEF,0xEF],
"descpointer": [0xE6,0x3D], "mp_cost": 1, "targeting": [0x80,0]}
...
catattack = {"attack_byte": 4, "effect": 0, "tech_id": 0x2B, "efpointer": [3,0,0,0x3A,0x3B,5,0x3E,0x80,0,0x14,4,0],
"anim": [0x2B,0x61,0,1,0,0,0xFF], "text": [0xA2,0xBA,0xCD,0xFF,0xA0,0xCD,0xCD,0xBA,0xBC,0xC4,0xEF],
"descpointer": [8,0x3E], "mp_cost": 3, "targeting": [7,0]}
...
"descpointer": [0x18,0x3E], "mp_cost": 4, "targeting": [7,0]}
...
tailspin = {"attack_byte": 2, "effect": 0, "tech_id": 0x2E, "efpointer": [3,0,0,0,0,3,0x3C,0x70,0,0x28,0,0],
"anim": [0x2F,0x61,0,1,0,0,6], "text": [0xB3,0xBA,0xC2,0xC5,0xFF,0xB2,0xC9,0xC2,0xC7,0xEF,0xEF],
"descpointer": [0x30,0x3E], "mp_cost": 10, "targeting": [0x11,2]}
...
triplekick = {"attack_byte": 4, "effect": 0x13, "tech_id": 0x30, "efpointer": [8,3,0,0x3A,0x3B,5,0x3E,0x80,0,0x25,4,0],
...
lightning2_2 = {"attack_byte": 0x82, "effect": 7, "tech_id": 0x31, "efpointer": [3,0,0,0,0,3,0x3C,0x70,0,0x12,0,0],
...
ice2_2 = {"attack_byte": 0x22, "effect": 7, "tech_id": 0x32, "efpointer": [3,0,0,0,0,3,0x3C,0x70,0,0x12,0,0],
...
fire2_2 = {"attack_byte": 0x12, "effect": 7, "tech_id": 0x33, "efpointer": [3,0,0,0,0,3,0x3C,0x70,0,0x12,0,0],
...
"descpointer": [0xCA,0x3E], "mp_cost": 8, "targeting": [0,0]}
...
def rewrite_menu_techs():
    ...
    while tech_i < len(menu_techs):
        outfile.seek(menu_start + menu_i)
        outfile.write(st.pack("B",new_ids[menu_techs[tech_i]]))
        menu_i += 3
        tech_i += 1

def write_bytes(array,pointer):
    if isinstance(array,int):
       outfile.seek(pointer)
       outfile.write(st.pack("B",array))
    elif isinstance(array,list):
        for byte in array:
           outfile.seek(pointer)
           outfile.write(st.pack("B",byte))
           pointer += 1
...
def rewrite_combo_techs():
    ...
    #Aura Whirl
    outfile.write(st.pack("B",new_ids["aura"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",0x80 | new_ids["cyclone"]))
    combo_tech_address += 11
    #Ice Sword
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["spincut"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["ice"]))
    combo_tech_address += 11
    #Ice Sword 2
    outfile.seek(combo_tech_address+1) 
    ...
    outfile.write(st.pack("B",new_ids["ice2"]))
    combo_tech_address += 11
	#Fire Whirl
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["cyclone"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["flametoss"]))
    combo_tech_address += 11
    #Fire Sword
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["spincut"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["fire"]))
    combo_tech_address += 11
    #Fire Sword 2
    outfile.seek(combo_tech_address+1)#See Ice Sword 2
    outfile.write(st.pack("B",new_ids["fire2"]))
    combo_tech_address += 11
    #Rocket Roll
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",0x80 | new_ids["cyclone"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["laserspin"]))
    combo_tech_address += 11
    #Max Cyclone
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",0x80 | new_ids["laserspin"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["spincut"]))
    combo_tech_address += 11
    #Super Volt
    ...
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["shock"]))
    combo_tech_address += 11
    #X Strike
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["cyclone"]))
    #Frog uses an alternate tech to get around some enemies being immune to Slurp Cut
    combo_tech_address += 11
    #Sword Stream
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["water"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["spincut"]))
    combo_tech_address += 11
    #Spire
    ...
    #Drill Kick
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["rollokick"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",0x80 | new_ids["cyclone"]))
    combo_tech_address += 11
    #Volt Bite
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["catattack"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",0x80 | new_ids["lightning"]))
    combo_tech_address += 11
    #Falcon Hit
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",0x80 | new_ids["rockthrow"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["spincut"]))
    combo_tech_address += 11
    #Antipode
    ...
    outfile.write(st.pack("B",new_ids["ice2"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["flare"]))
    combo_tech_address += 11
    #Aura Beam
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["aura"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",0x80 | new_ids["curebeam"]))
    combo_tech_address += 11
    #Ice Tackle
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["robotackle"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["ice"]))
    combo_tech_address += 11
    #Cure Touch
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["cure"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",0x80 | new_ids["healbeam"]))
    combo_tech_address += 11
    #Ice Water
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["water"]))
    ...
    #Glacier
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["water2"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["ice2"]))
    combo_tech_address += 11
    #Double Cure
    outfile.seek(combo_tech_address+1)#Double Cure uses a different spell that cures full HP and restores status
    outfile.write(st.pack("B",0x80 | new_ids["cure2_2"]))
    combo_tech_address += 11
    #Twin Charm
    outfile.seek(combo_tech_address+1)#Twin Charm uses a different spell with a higher chance of stealing
    outfile.write(st.pack("B",0x80 | new_ids["provoke"]))
    combo_tech_address += 11
    #Ice Toss
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["rockthrow"]))    
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["ice"]))
    combo_tech_address += 11
    #Cube Toss
    ...
    #Fire Punch
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["rocketpunch"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["fire"]))
    combo_tech_address += 11
    #Fire Tackle
    ...
    #Doublev Bomb
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["areabomb"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["megabomb"]))
    combo_tech_address += 11
    #Flame Kick
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["rollokick"]))
    ...
    #Fire Whirl
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["tailspin"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["fire2"]))
    combo_tech_address += 11
    #Blaze Kick
    #Similar to Confuse, Triple Kick is substituted with a single attack version in combo techs
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["fire2"]))
    combo_tech_address += 11
    #Blade Toss
    ...
    outfile.write(st.pack("B",new_ids["robotackle"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",0x80 | new_ids["water"]))
    combo_tech_address += 11
    #Cure Wave
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["cure2_2"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B", 0x80 | new_ids["healbeam"]))
    combo_tech_address += 11
    #Boogie
    outfile.seek(combo_tech_address+1)#Boogie uses a unique spell that sets Stop
    outfile.write(st.pack("B",0x80 | new_ids["laserspin"]))
    combo_tech_address += 11
    #Spin Kick
    outfile.seek(combo_tech_address)
    ...
    outfile.write(st.pack("B",new_ids["rockthrow"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["uzzipunch"]))
    combo_tech_address += 11
    #Slurp Kiss
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",0x80 | new_ids["slurp"]))
    #Next line is skipped because a stronger healing spell is used in place of Kiss.
    combo_tech_address += 11
    #Bubble Hit
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["rollokick"]))
    ...
    #Line Bomb
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",0x80 | new_ids["leapslash"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["megabomb"]))
    combo_tech_address += 11
    #Frog Flare
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["frogsquash"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["flare"]))
    combo_tech_address += 11
    #Delta Force
    ...
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["ice2"]))
    outfile.seek(combo_tech_address+2)
    outfile.write(st.pack("B",new_ids["fire2"]))
    combo_tech_address += 11
    #Lifeline
    outfile.seek(combo_tech_address+1)#Lifeline uses a unique spell to set GreenDream effect
    outfile.write(st.pack("B",0x80 | new_ids["life"]))
    outfile.seek(combo_tech_address+2)
    outfile.write(st.pack("B",0x80 | new_ids["laserspin"]))
    combo_tech_address += 11
    #Arc Impulse
    ...
    #Fire Zone
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",0x80 | new_ids["robotackle"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",new_ids["spincut"]))
    outfile.seek(combo_tech_address+2)
    outfile.write(st.pack("B",new_ids["fire2"]))
    ...
    outfile.write(st.pack("B",new_ids["fire2"]))
    outfile.seek(combo_tech_address+2)
    outfile.write(st.pack("B",new_ids["darkmatter"]))
    combo_tech_address += 11
    #Omega Flare
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["flare"]))
    ...
    outfile.write(st.pack("B",new_ids["laserspin"]))
    outfile.seek(combo_tech_address+2)
    outfile.write(st.pack("B",new_ids["darkbomb"]))
    combo_tech_address += 11
    #Spin Strike
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",new_ids["leapslash"]))
    ...
    outfile.write(st.pack("B",0x80 | new_ids["robotackle"]))
    outfile.seek(combo_tech_address+2)
    outfile.write(st.pack("B",0x80 | new_ids["dinotail"]))
    combo_tech_address += 11
    #Poyozo Dance
    outfile.seek(combo_tech_address)
    outfile.write(st.pack("B",0x80 | new_ids["provoke"]))
    outfile.seek(combo_tech_address+1)
    outfile.write(st.pack("B",0x80 | new_ids["hypnowave"]))
    outfile.seek(combo_tech_address+2)
    outfile.write(st.pack("B", new_ids["tailspin"]))
    combo_tech_address += 11
    #Grand Dream
    outfile.seek(combo_tech_address+1)#Grand Dream uses a unique spell that's stronger than Frog Squash
    outfile.write(st.pack("B",0x80 | new_ids["life2"]))
    outfile.seek(combo_tech_address+2)
    outfile.write(st.pack("B",0x80 | new_ids["healbeam"]))
...
global outfile
file_pointer = input("Enter file name or drag it onto the window.")
file_pointer = file_pointer.strip("\"")
seed = input("Enter seed, or leave blank if you want it to be generated.")
if seed == None or seed == "":
   seed = rand.randint(0,10000001)
rand.seed(seed)
outfile = file_pointer.split(".")
outfile = "%s%d.sfc"%(str(outfile[0]),seed)
copyfile(file_pointer,outfile)
...
nizbel_check = 0xCAABD
nizbel_fix = [0x15,0x80,00,00,0xFE,0x11,0x3E,0x7F,0x3C,0x32,0x3E,0x7F,0x3C,0x32,0x39,0xFE,00,00,00,00,0xFE,00,00,0x06,
00,0xFE,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF]
for byte in nizbel_fix:
    outfile.seek(nizbel_check)
    outfile.write(st.pack("B",byte))
    nizbel_check += 1
nizbel_ii_check = 0xCAB38
nizbel_ii_fix = [0x15,0x80,00,00,0xFE,0x14,0x3E,0xA0,0x37,00,0x37,00,0x37,0x01,0x39,0xFE,00,00,00,00,0xFE,0x0C,0x3E,
0x30,0x3E,0xFE,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF]
for byte in nizbel_ii_fix:
    outfile.seek(nizbel_ii_check)
    outfile.write(st.pack("B",byte))
    nizbel_ii_check += 1
outfile.close()